...
function Chat(props) {
    ...
    const [id, setId] = useState('BG3ZaZqI2TWb8Pt9VVsupcNYrgo1')
    let unSub = null;
        ...
        (async ()=>{
            ...
            unSub = onSnapshot(collectionRef,(snapShot) => {
                ...
                snapShot.forEach(doc =>{
                    localMessage.push({id:doc.id,message:doc.data().message});
                });
                                    ...
                                    return (
                                        <div>
                                            ...
                                            <div className="chat-message">
                                                <div className={id === id ? "flex items-end justify-end" : "flex items-end"}>
                                                    <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                                                        <div><span
                                                            className="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">{messageItem.message}</span>
                                                        </div>
                                                    </div>
                                                    <img
